...
enum AntialiasedElement {
  ...
  ,
  aePlottables = 0x0020 ///< <tt>0x0020</tt> Main lines of plottables (excluding
...
public:
  ...
  */
  ...
  Q_SLOT void
  replot(QCustomPlot::RefreshPriority refreshPriority = QCustomPlot::rpHint);
...
protected:
  ...
  double
  candlestickSelectTest(const QPointF &pos,
                        const QCPFinancialDataMap::const_iterator &begin,
                        const QCPFinancialDataMap::const_iterator &end) const;
